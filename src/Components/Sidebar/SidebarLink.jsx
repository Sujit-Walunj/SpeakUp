  ...
  return (
    <div>
      <Link
        ...
        ${matchRoute(data.path) ? 'text-slate-900 bg-blue-200' : 'text-slate-700'}`}
      >
        <span className={`absolute left-0 top-0 h-full w-[0.15rem] bg-blue-700 ${matchRoute(data.path) ? ' opacity-100 ' : 'opacity-0'}`} >
        </span>
